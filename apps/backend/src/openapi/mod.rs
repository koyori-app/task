...
fn register_tags(openapi: &mut OpenApi) {
    openapi.tags = Some(vec![
        TagBuilder::new()
            .name("Auth")
            .description(Some("認証・セッション・パスキー管理"))
            .build(),
        TagBuilder::new()
            .name("Tenants")
            .description(Some("テナント管理"))
            .build(),
        TagBuilder::new()
            .name("Projects")
            .description(Some("プロジェクト管理"))
            .build(),
        TagBuilder::new()
            .name("Project Members")
            .description(Some("プロジェクトメンバー管理"))
            .build(),
        TagBuilder::new()
            .name("Labels")
            .description(Some("ラベル一覧"))
            .build(),
        TagBuilder::new()
            .name("Custom Fields")
        ...
        TagBuilder::new()
            ...
            .description(Some("パーソナルアクセストークン（PAT）管理"))
            .build(),
        TagBuilder::new()
            .name("Drive Files")
            .description(Some("ドライブ — ファイル操作"))
            .build(),
        TagBuilder::new()
            .name("Drive Folders")
            .description(Some("ドライブ — フォルダ管理"))
            .build(),
        TagBuilder::new()
            .name("Drive Shares")
            .description(Some("ドライブ — フォルダ共有・公開リンク"))
            .build(),
        TagBuilder::new()
            .name("Admin Users")
