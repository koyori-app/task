...
use service::{password_reset, password_reset_email_delivery, password_reset_log};
...
pub async fn process(job: PasswordResetEmailJob, state: Data<JobState>) -> Result<(), BoxDynError> {
