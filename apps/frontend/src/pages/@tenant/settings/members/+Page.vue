...
import TenantSettingsMembers from '@/components/tenants/TenantSettingsMembers.vue';
...
<template>
  <div class="flex min-h-0 flex-1 flex-col">
    ...
    <!--
      テナントを切り替えたら作り直す。vike-vue は同じ `+Page.vue` に解決される
      URL 間ではコンポーネントを patch するため、置かないと前のテナントの
      メンバーを表示したまま操作だけが今のテナントへ飛ぶ。
    -->
    <TenantSettingsMembers
